...
<img class="slide-image" src="images/content-page-image.png" style="width:30%; top:15%; left:75%" />
...
# Divide and Conquer
<img class="slide-image" src="images/divide-and-conquer.png" style="width:50%; top:45%; left:25%" />
...
```
<img class="slide-image" src="images/merge-sort.png" style="width:50%; bottom:0%; left:22%" />
...
<img class="slide-image" src="images/closest-pair.png" style="width:30%; top:10%; right:0%" />
<img class="slide-image" src="images/hanoi-towers.png" style="width:40%; top:50%; right:0%" />
...
<img class="slide-image" src="images/fibonacci-spiral.png" style="width:45%; bottom:0%; right:0%" />
...
<img class="slide-image" src="images/fibonacci-tree.png" style="width:55%; bottom:0%; left:20%" />
...
<img class="slide-image" src="images/fibonacci-dp.png" style="position:initial; width:100%; margin:10px 0" />
...
<img class="slide-image" src="images/labirynth.png" style="width:35%; bottom:0%; right:0%" />
...
<img class="slide-image" src="images/lcs.png" style="width:80%; top:55%; left:10%" />
...
<img class="slide-image" src="images/lcs-table.png" style="width:50%; top:40%; left:25%" />
...
<img class="slide-image" src="images/lcs-table2.png" style="width:40%; top:50%; left:65%" />
...
<img class="slide-image" src="images/lcs-base.png" style="width:50%; top:40%; left:50%" />
...
<img class="slide-image" src="images/lcs-solved.png" style="width:25%; top:20%; left:70%" />
...
<img class="slide-image" src="images/lcs-answer.png" style="width:35%; bottom:0%; right:0%" />
...
<img class="slide-image" src="images/subset-sum.png" style="width:30%; top:45%; left:65%" />
...
<img class="slide-image" src="images/subset-sum-console.png" style="width:45%; bottom:5%; right:0%" />


<!-- section start -->
<!-- attr: { class:'sl ide-section', showInPresentation:true, hasScriptWrapper:true, style:'' } -->
# Longest Increasing Subsequence
<img class="slide-image" src="images/longest-increasing-subsequence.png" style="width:80%; bottom:5%; left:10%" />
...
<img class="slide-image" src="images/lis.png" style="width:50%; top:70%; left:50%" />
...
<img class="slide-image" src="images/lis-restore.png" style="width:60%; top:65%; left:20%" />
