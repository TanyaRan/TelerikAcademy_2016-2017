...
<img class="slide-image" src="images/generating-01-vectors.png" style="position:initial; width:80%; margin-left:10%" />
...
<img class="slide-image" src="images/generating-combinations.png" style="position:initial; width:70%; margin-left:15%" />
...
<img class="slide-image" src="images/the-8-queens.png" style="position:initial; width:30%; margin-left:35%" />
...
<img class="slide-image" src="images/labyrinth.png" style="width:30%; top:65%; left:30%" />

<!-- attr: { showInPresentation:true, hasScriptWrapper:true, style:'' } -->
<!-- # Finding All Paths in a Labyrinth -->
- There are 3 different paths from the top left corner to the bottom right corner:

<img class="slide-image" src="images/labyrinth1.png" style="width:35%; top:30%; left:0%" />
<img class="slide-image" src="images/labyrinth2.png" style="width:35%; top:30%; right:10%" />
<img class="slide-image" src="images/labyrinth3.png" style="width:35%; top:60%; left:28%" />
...
<img class="slide-image" src="images/recursive-fibonacci.png" style="position:initial; width:80%; margin-left:5%" />
