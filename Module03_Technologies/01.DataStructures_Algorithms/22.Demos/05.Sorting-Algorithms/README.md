...
<img class="slide-image" src="images/heap-tree.png" style="width:30%; top:52%; left:67%" />
...
<img class="slide-image" src="images/counting-sort.png" style="width:35%; top:27%; right:0%" />
