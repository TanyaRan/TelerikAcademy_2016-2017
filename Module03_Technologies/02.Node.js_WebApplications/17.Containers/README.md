...
<!-- <img class="slide-image" showInPresentation="true" src="images/01.png" style="top:37%; right:5%; width:45%; z-index:-1; border-radius: 15px" /> -->
...
<!-- <img class="slide-image" showInPresentation="true" src="images/01.png" style="top:38.5%; right:60%; width:45%; z-index:-1; border-radius: 15px" /> -->
<!-- <img class="slide-image" showInPresentation="true" src="images/02.png" style="top:20%; right:5%; width:45%; z-index:-1; border-radius: 15px" /> -->
...
<!-- <img class="slide-image" showInPresentation="true" src="images/03.png" style="top:20%; right:10%; width:85%; z-index:-1; border-radius: 15px" /> -->
...
<!-- <img class="slide-image" showInPresentation="true" src="images/05.png" style="top:35%; right:5%; width:35%; z-index:-1; border-radius: 15px" /> -->
