...
<img class="slide-image" showInPresentation="true"  src="images/pic13.png" style="top:27.13%; left:5.55%; width:95.55%;border-radius:10px;  z-index:-1; background-color: rgba(222,222,222,0.7)" />
