...
string str = "telerik";
```
<img class="slide-image" src="images/values.png" style="top:35%; left:14.83%; width:76.91%; z-index:-1" />
...
<img class="slide-image" src="images/pic39.png" style="top:48.55%; left:63.41%; width:36.14%; z-index:-1" />
